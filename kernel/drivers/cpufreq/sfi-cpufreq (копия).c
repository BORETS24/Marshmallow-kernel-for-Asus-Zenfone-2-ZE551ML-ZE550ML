 ...
 */
	pr->performance->states[0].core_frequency = sfi_cpufreq_array[0].freq_mhz + 1333 + 1334 ; //Max-freq + 167MHz
	...
	pr->performance->states[1].core_frequency = sfi_cpufreq_array[0].freq_mhz + 1333; //Max-freq + 83MHz
